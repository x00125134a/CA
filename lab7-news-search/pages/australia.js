...
// Get your own key!
const apiKey = 'e152d97624db4d0c8d40b5191486c7ed';

// Initial News source
const defaultNewsSource = 'google-news-au';
    ...
    return (
      <div>
        ...
        <ul className="newsMenu">
          <li><a href="#" onClick={this.searchNewsAPI} name="top-headlines?country=au">Top Headlines Australia</a></li>
          <li><a href="#" onClick={this.searchNewsAPI} name="top-headlines?country=au&category=business">Business News Australia</a></li>
          <li><a href="#" onClick={this.searchNewsAPI} name="everything?q=technology">Technology News</a></li>
          <li><a href="#" onClick={this.searchNewsAPI} name="top-headlines?country=au&category=weather">Weather in Australia </a></li>
        </ul>
