    ...
    return (
      <div>
        ...
        <ul className="newsMenu">
          <li><a href="#" onClick={this.searchNewsAPI} name="top-headlines?country=us">Top Headlines America</a></li>
          <li><a href="#" onClick={this.searchNewsAPI} name="top-headlines?country=us&category=business">Business News America</a></li>
          <li><a href="#" onClick={this.searchNewsAPI} name="everything?q=technology">Technology News</a></li>
          <li><a href="#" onClick={this.searchNewsAPI} name="top-headlines?country=us&category=weather">Weather in America </a></li>
        </ul>
