    ...
    return (
      <div>
        ...
        <ul className="newsMenu">
          <li><a href="#" onClick={this.searchNewsAPI} name="top-headlines?country=uk">Top Headlines United Kingdom</a></li>
          <li><a href="#" onClick={this.searchNewsAPI} name="top-headlines?country=uk&category=business">Business News United Kingdom</a></li>
          <li><a href="#" onClick={this.searchNewsAPI} name="everything?q=technology">Technology News</a></li>
          <li><a href="#" onClick={this.searchNewsAPI} name="top-headlines?country=uk&category=weather">Weather in United Kingdom </a></li>
        </ul>
